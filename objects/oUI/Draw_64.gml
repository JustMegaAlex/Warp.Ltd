...
draw_text_ext_transformed(ui_x + 56, h + coins_rely + text_shift_y, string(oPlayer.coins), 0, 100, ui_scale, ui_scale, 0)
// clips
draw_sprite_ext(sUIPlazmaClip, 0, clip_x, h + ammo_rely,  ui_scale, ui_scale, 0, c_white, 1)
draw_text_ext_transformed(clip_x + 8, h + ammo_rely + text_shift_y, string(oPlayer.plazma_clips), 0, 100, ui_scale, ui_scale, 0)
// heals
draw_sprite_ext(sUIStipPack, 0, stim_x, h + ammo_rely,  ui_scale, ui_scale, 0, c_white, 1)
draw_text_ext_transformed(stim_x + 8, h + ammo_rely + text_shift_y, string(oPlayer.stimpacks), 0, 100, ui_scale, ui_scale, 0)
